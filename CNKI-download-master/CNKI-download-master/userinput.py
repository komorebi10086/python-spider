...
def get_uesr_inpt():
    ...
    处理用户所需搜索的全部条件
    '''
    condition_fields = search_condition(False)
...
def search_condition(is_not_unit):
    '''
    用户输入检索条件
    '''
    print('－－－－－－－－－－－－－－－－－－－－－－－－－－')
    ...
    for index, term in enumerate(select_condition):
        ...
        # # condition_field_list['au_1_value2'] = condition_value
        # condition_field_list['txt_' + str(index + 1) +
        #                      '_relation'] = '#CNKI_AND'
        ...
        if is_not_unit:
            ...
            condition_field_list['au_1_value2'] = condition_value
            condition_field_list['au_1_sel'] = 'AU'
